 ...
 * @author Usuario
 */
public class sr_categoria extends HttpServlet {
    Categoria categoria;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            categoria = new Categoria(Integer.valueOf(request.getParameter("drop_producto_cat")), Integer.valueOf(request.getParameter("txt_id")), request.getParameter("txt_nombre_cat"));
            // Boton agregar 
