...
Usuario usuario;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           usuario = new Usuario(Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_nombre_usuario"),request.getParameter("txt_contrasena"),request.getParameter("txt_rol"));
